...
API_KEY = "F3XLGZAWKNNSB2ST"
#ENDPOINT_SCHEMA_URL  = os.getenv('ENDPOINT_SCHEMA_URL',None)
ENDPOINT_SCHEMA_URL  = "https://psrc-kk5gg.europe-west3.gcp.confluent.cloud"
#API_SECRET_KEY = os.getenv('API_SECRET_KEY',None)
API_SECRET_KEY = "qswjEw7nt6VyOSpwh/0/quLslxXPKnKYhhHgDTF+gVNjRg7iEwOAmZTgtSKW1Kd6"
...
SCHEMA_REGISTRY_API_KEY = "46IOUD3E34PVVPV6"
#SCHEMA_REGISTRY_API_SECRET = os.getenv('SCHEMA_REGISTRY_API_SECRET',None)
SCHEMA_REGISTRY_API_SECRET = "E69QUK6I3SKsKjgxZlnd8uEaTXbbeQKR2mbaPs9yZk+JFo+xQPThiJVvyfwhlVjy"
